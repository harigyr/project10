package org.hari10.com.jsf.composite;
...
import org.hari10.com.utils.FacesUtils;
...
public class BaseBeanBasedCompositeComponent extends UINamingContainer {
    ...
    public String getDatePattern() {
        if (getAttributes().get("time").equals(BOOLEAN_TRUE_STRING)) {
            return FacesUtils.getMessage("hari10.dateTimeFormat");
        } else {
            return FacesUtils.getMessage("hari10.dateFormat");
        }
    }
