package org.hari10.com.customrepository;
...
public class GenericRepositoryImpl<T, ID extends Serializable> extends QueryDslJpaRepository<T, ID> implements
    ...
    /**
     * @see org.hari10.com.customrepository.GenericRepository#findOne(java.io.Serializable, java.util.List)
     */
    @Override
    ...
    /**
     * @see org.hari10.com.customrepository.GenericRepository#findAll(com.mysema.query.types.Predicate, org.springframework.data.domain.Pageable, java.util.List)
     */
    @Override
